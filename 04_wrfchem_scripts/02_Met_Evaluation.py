...
paths = [i for i in sorted(glob.glob('01_data/raw/mod/rain/*.pickle'))]
rain = {}
...
mod_sep18 = pd.read_csv('01_data/raw/mod/Y2018/sep18/0_FIN_d02.csv')
...
mod_oct18 = pd.read_csv('01_data/raw/mod/Y2018/oct18/0_FIN_d02.csv')
